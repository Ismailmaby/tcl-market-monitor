...
def sections_to_podcast_script(sections, run_date):
    ...
    lines = [
        "Good morning. This is your TCL Market Intelligence briefing for " + date_str + ". "
        "I'm covering hospitality TV and commercial display opportunities across the Middle East, Africa, and Latin America. "
        "Let's get into it.",
        "",
    ]
    for s in sections:
        ...
        lines.append("")
    lines.append(
        "That concludes today's TCL Market Intelligence briefing. "
        "Stay sharp, stay ahead. Good selling."
    )
