...
def get_prompt():
    ...
    return (
        "Market intelligence analyst for TCL hospitality TV, MEA and LATAM. Today: " + today + ".\n"
        "Return ONLY this JSON (no extra text, keep each insight under 30 words):\n"
        '{"sections":['
        '{"title":"MEA Hotel Market","items":[{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"}]},'
        '{"title":"LATAM Hotel Market","items":[{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"}]},'
        '{"title":"Competitive Intelligence Samsung LG","items":[{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"}]},'
        '{"title":"Hospitality Technology IPTV","items":[{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"}]},'
        '{"title":"BD Opportunities This Week","items":[{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"},{"headline":"X","insight":"X","action":"X"}]}'
        "]}\n"
        "Topics: UAE/Saudi hotel openings, Brazil LATAM hospitality, Samsung LYNK vs LG ProCentric, IPTV Nonius Acentic, TCL BD actions."
    )
...
def main():
    ...
    print("Model: " + MODEL + " | Max tokens: 800")
    try:
